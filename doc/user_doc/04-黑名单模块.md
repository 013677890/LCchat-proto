...
**请求信息**:
```
DELETE /api/v1/user/blacklist/{userUuid}
```
...
**请求示例**:
```
DELETE /api/v1/user/blacklist/user-uuid-003
```
...
**请求示例**:
```
GET /api/v1/user/blacklist?page=1&pageSize=20
```
...
**请求信息**:
```
POST /api/v1/user/blacklist/check
```
